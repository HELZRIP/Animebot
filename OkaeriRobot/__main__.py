...
import sys
import traceback
import OkaeriRobot.modules.sql.users_sql as sql
from sys import argv
from typing import Optional
from telegram import __version__ as peler
from platform import python_version as memek
from OkaeriRobot import (
    ALLOW_EXCL,
    CERT_PATH,
    DONATION_LINK,
    LOGGER,
...
from OkaeriRobot.modules import ALL_MODULES
from OkaeriRobot.modules.helper_funcs.chat_status import is_user_admin
from OkaeriRobot.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("OkaeriRobot.modules." + module_name)
...
def Okaeri_about_callback(update, context):
    query = update.callback_query
    if query.data == "Okaeri_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="ᴀᴅᴍɪɴs​", callback_data="Okaeri_admin"
                        ),
                        InlineKeyboardButton(
                            text="ɴᴏᴛᴇs​", callback_data="Okaeri_notes"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                            text="sᴜᴘᴘᴏʀᴛ​", callback_data="Okaeri_support"
                        ),
                        InlineKeyboardButton(
                            text="ᴄʀᴇᴅɪᴛs​", callback_data="Okaeri_credit"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                    ...
                    [
                        InlineKeyboardButton(
                            text="ɢᴏ ʙᴀᴄᴋ​", callback_data="Okaeri_back"
                        ),
                    ],
                ]
            ),
        )
    elif query.data == "Okaeri_back":
        first_name = update.effective_user.first_name
        uptime = get_readable_time((time.time() - StartTime))
        query.message.edit_text(
            PM_START_TEXT.format(
        ...
        query.message.edit_text(
            ...
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="ɢᴏ ʙᴀᴄᴋ​", callback_data="Okaeri_")]]
            ),
        )

    elif query.data == "Okaeri_notes":
        query.message.edit_text(
    ...
    elif query.data == "Okaeri_support":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ​", url="t.me/OkaeriUserbot"),
                        InlineKeyboardButton(
                            text="ᴜᴘᴅᴀᴛᴇs​", url="https://t.me/nbzoning"
                        ),
                    ],
                    [
                        InlineKeyboardButton(text="ɢᴏ ʙᴀᴄᴋ​", callback_data="Okaeri_"),
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text="Okaeri", url="t.me/zenfrans"),
                    ],
                    [
                        InlineKeyboardButton(text="ɢᴏ ʙᴀᴄᴋ​", callback_data="Okaeri_"),
                    ],
...
**Telegram Library:** `v{peler}`""",
    ...
    about_callback_handler = CallbackQueryHandler(
        Okaeri_about_callback, pattern=r"Okaeri_", run_async=True
    )
