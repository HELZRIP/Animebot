...
from SkyzuRobot.modules.purge import client
from SkyzuRobot.modules.sql import users_sql as sql
...
def main():
    ...
    if WEBHOOK:
        LOGGER.info("[Okaeri] Using webhooks.")
        ...
        LOGGER.info("[Okaeri] Using long polling.")
...
if __name__ == "__main__":
    LOGGER.info("[Okaeri] Successfully loaded modules: " + str(ALL_MODULES))
